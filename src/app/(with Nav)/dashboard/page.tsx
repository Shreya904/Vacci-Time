...
const DashBoard = () => {
  return (
    <div className="flex flex-col md:flex-row items-center md:items-start p-8 bg-[#09111f] min-h-screen w-full">
      {/* Image Section */}
      <Image
        src={chImg}
        height={1000}
      ...
      {/* Text Section */}
      <div className="flex-1 space-y-6 bg-[#0f172a] p-8 rounded-lg shadow-md max-w-2xl h-full">
        <div className="mb-6">
